...
export function NotFoundComponent() {
  ...
  const renderMode = getNotFoundRenderMode(runtimeConfig !== undefined, redirectUrl);
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700&family=Inter:wght@400;500;600;700&subset=cyrillic,cyrillic-ext,latin,latin-ext&display=swap",
      },
    ],
  }),
